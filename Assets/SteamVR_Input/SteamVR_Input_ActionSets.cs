...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_SoundForest p_SoundForest;
        ...
        public static SteamVR_Input_ActionSet_SoundForest SoundForest
        {
            get
            {
                return SteamVR_Actions.p_SoundForest.GetCopy<SteamVR_Input_ActionSet_SoundForest>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_SoundForest = ((SteamVR_Input_ActionSet_SoundForest)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_SoundForest>("/actions/SoundForest")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.SoundForest};
        }
    }
}
